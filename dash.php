...
<body onload="Dashboard()">
	...
	<header>
		...
		<div class="logout">
			...
			<a href="login.php"><img src="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fcdn2.iconfinder.com%2Fdata%2Ficons%2Fflaticons-stroke%2F16%2Flogout-1-512.png&f=1&nofb=1" height="30px" width="30px" alt="Logout Button"></a>
		</div>
	</header>
